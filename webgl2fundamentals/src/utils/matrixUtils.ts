export namespace Mat3 {
    ...
    export function project(m: Float32Array, width: number, height: number, dst?: Float32Array) {
        return multiply(m, projection(width, height), dst);
    }

    export function translation(tx: number, ty: number, dst?: Float32Array) {
        dst = dst || new Float32Array(9);
    ...
    export function translate(m: Float32Array, tx: number, ty: number, dst?: Float32Array) {
    ...
    export function rotate(m: Float32Array, angleInRadians: number, dst?: Float32Array) {
        return multiply(m, rotation(angleInRadians), dst);
    }

    export function scaling(sx: number, sy: number, dst?: Float32Array) {
        dst = dst || new Float32Array(9);
    ...
    export function scale(m: Float32Array, sx: number, sy: number, dst?: Float32Array) {
    ...
    export function transformPoint(m: Float32Array, v: Float32Array) {
        var v0 = v[0];
        var v1 = v[1];
